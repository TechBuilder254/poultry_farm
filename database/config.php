...
if (isset($_POST['purchase-medicine'])) {
    ...
    $name_idd = isset($_POST['name_idd']) ? $_POST['name_idd'] : null;
    ...
    if ($name_idd && $date && $name && $rate && $qty && $t_amount && $supplier) {
        // Proceed with the database insertion
        $query = "INSERT INTO `medicine_purchase`(name_idd, date, name, rate, qty, t_amount, supplier)
